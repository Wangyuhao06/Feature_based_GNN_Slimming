...
def train_student(args, auxiliary_model, data, device):
    ...
    feat_gated_s_model = auxiliary_model['feat_gated_s_model']['model']
    ...
    for epoch in range(args.s_epochs):
        ...
        for batch, batch_data in enumerate( zip(train_dataloader,fixed_train_dataloader) ):
            ...
            logits, middle_feats_s = feat_gated_s_model(feats.float(), middle=True)
        ...
        if epoch % 10 == 0:
            ...
            if score > best_score or loss_data < best_loss:
                best_score = score
                best_loss = loss_data
                test_score = test_model(test_dataloader, feat_gated_s_model, device, loss_fcn)
