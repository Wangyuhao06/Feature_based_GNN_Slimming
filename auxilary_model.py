import torch
from utils import get_teacher, get_student, get_feat_info, get_feat_gated_student
...
def collect_model(args, data_info):
    ...
    feat_gated_s_model = get_feat_gated_student(args, data_info);    feat_gated_s_model.to(device) # NOTE: MODIFIED
    ...
    feat_gated_s_model_optimizer = torch.optim.Adam(feat_gated_s_model.parameters(), lr=args.lr, weight_decay=args.weight_decay) # NOTE: MODIFIED
    ...
    model_dict['feat_gated_s_model'] = {'model':feat_gated_s_model, 'optimizer':feat_gated_s_model_optimizer} # NOTE: MODIFIED
