...
from BNN_layers import Feat_Gate
...
class Feature_Gated_GAT(nn.Module):  # NOTE: MODIFIED
    """This is the definition of the Feature_Gated_GAT models
    ...
    def __init__(self,
        ...
        super(Feature_Gated_GAT, self).__init__()
        self.g = g
        self.num_layers = num_layers
        self.gat_layers = nn.ModuleList()
        self.activation = activation

        self.feat_gate_layer = Feat_Gate(in_dim, in_dim)
